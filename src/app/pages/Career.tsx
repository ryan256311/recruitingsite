    ...
    <>
      ...
      <section className="pt-[90px] max-[1039px]:pt-[68px] max-[539px]:pt-[58px] pb-24 border-b border-black/15 relative">
        ...
        <div className="absolute top-[102px] left-[54px] max-[1039px]:top-[75px] max-[539px]:top-[59px] max-[539px]:left-[30px]">
          <code className="text-[#313131]" style={{ fontFamily: 'Verdana, sans-serif', fontSize: 'var(--marker-font-size)' }}>{`<h1 class="career">`}</code>
        </div>
      ...
      <section id="selection-flow" className="relative py-24 border-b border-black/15">
        ...
        <div className="max-w-[1180px] mx-auto px-8">
          ...
          <div className="flex items-center justify-between max-w-[1000px] mx-auto mb-12 max-[1039px]:flex-col max-[1039px]:items-stretch max-[1039px]:gap-4">
            {[
              ...
              <div key={index} className="flex items-center">
                ...
                {index < arr.length - 1 && (
                  <svg className="w-6 h-6 mx-4 text-[#0064c8] max-[1039px]:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section id="job-listings" className="relative py-24 border-b border-black/15">
        ...
        <div className="max-w-[1180px] mx-auto px-8">
          ...
          <div className="grid grid-cols-2 gap-6 mb-12 max-[1039px]:grid-cols-1 max-[539px]:grid-cols-1">
          ...
          <div className="flex justify-center">
            <a href="/contact?type=career" className="inline-flex items-center gap-4 bg-[#0064c8] text-white rounded-full px-10 py-4 hover:bg-[#0054a8] transition-colors">
