...
export default function Graduate() {
  return (
    <>
      {/* ===== Hero Section (01) ===== */}
      <section className="pt-[90px] max-[1039px]:pt-[68px] max-[539px]:pt-[58px] pb-24 border-b border-black/15 relative">
        ...
        <div className="absolute top-[102px] left-[54px] max-[1039px]:top-[75px] max-[539px]:top-[59px] max-[539px]:left-[30px]">
          <code className="text-[#313131]" style={{ fontFamily: 'Verdana, sans-serif', fontSize: 'var(--marker-font-size)' }}>{`<h1 class="graduate">`}</code>
        </div>
        ...
        <div className="flex pt-8 max-[1039px]:flex-col-reverse">
          ...
          <div className="relative w-[248px] shrink-0 py-8 pl-[80px] pr-[14px] max-[1039px]:w-full max-[1039px]:pt-[40px] max-[1039px]:pb-[40px] max-[1039px]:pl-[82px] max-[1039px]:pr-[20px] max-[539px]:pl-[40px] max-[539px]:pr-[20px]">
            ...
            <div className="space-y-3 ml-[8px] max-[1039px]:grid max-[1039px]:grid-flow-col max-[1039px]:grid-rows-2 max-[1039px]:gap-x-8 max-[1039px]:gap-y-[14px] max-[1039px]:space-y-0 max-[1039px]:ml-0 max-[1039px]:max-w-[400px]">
              {[
          ...
          <div className="flex-1 py-8 pr-20 max-w-[1400px] pl-[4%] max-[1039px]:pl-[80px] max-[1039px]:pr-[20px] max-[1039px]:pb-[40px] max-[1039px]:border-b max-[1039px]:border-black/15 max-[539px]:pr-[40px] max-[539px]:pl-[40px]">
            <h1 className="text-h1 max-[1039px]:!text-[40px] max-[539px]:!text-[32px] tracking-[1.92px] mb-8">
              新卒採用
            </h1>
      ...
      <section id="work-environment" className="relative py-24 border-b border-black/15">
        ...
        <div className="absolute top-[6px] left-[54px] max-[539px]:top-0 max-[539px]:left-[30px]">
          <code className="text-[#313131]" style={{ fontFamily: 'Verdana, sans-serif', fontSize: 'var(--marker-font-size)' }}>{`<section class="work-environment">`}</code>
        </div>

        <div className="max-w-[1180px] mx-auto px-8">
          <div className="mb-8">
            <h2 className="font-bold tracking-[1.08px] mb-2 max-[539px]:!text-[26px]" style={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '36px' }}>仕事環境</h2>
            <div className="w-12 h-[2px] bg-[#313131] max-[539px]:w-[34px]"></div>
          </div>

          <div className="grid grid-cols-3 gap-8 mb-12 max-[1039px]:grid-cols-2 max-[539px]:grid-cols-1">
            {[
      ...
      <section id="requirements" className="relative py-24 border-b border-black/15">
        ...
        <div className="max-w-[1180px] mx-auto px-8">
          <div className="mb-8">
            <h2 className="font-bold tracking-[1.08px] mb-2 max-[539px]:!text-[26px]" style={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '36px' }}>募集要項</h2>
            <div className="w-12 h-[2px] bg-[#313131] max-[539px]:w-[34px]"></div>
          </div>
              ...
              <tbody>
                {[
                  ...
                  <tr key={index} className={`max-[1039px]:flex max-[1039px]:flex-col ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                    <th className="text-left py-5 px-8 w-[200px] font-semibold border-r border-[#e0e0e0] max-[1039px]:w-full max-[1039px]:border-r-0 max-[1039px]:pb-2">{item.label}</th>
      ...
      <section id="selection-flow" className="relative py-24 border-b border-black/15">
        ...
        <div className="absolute top-[6px] left-[54px] max-[539px]:top-0 max-[539px]:left-[30px]">
          <code className="text-[#313131]" style={{ fontFamily: 'Verdana, sans-serif', fontSize: 'var(--marker-font-size)' }}>{`<section class="selection-flow">`}</code>
        </div>

        <div className="max-w-[1180px] mx-auto px-8">
          <div className="mb-8">
            <h2 className="font-bold tracking-[1.08px] mb-2 max-[539px]:!text-[26px]" style={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '36px' }}>試験内容とフロー図</h2>
            <div className="w-12 h-[2px] bg-[#313131] max-[539px]:w-[34px]"></div>
          </div>
          ...
          <div className="flex items-center justify-between max-w-[1100px] mx-auto mb-12 max-[1039px]:flex-col max-[1039px]:items-stretch max-[1039px]:gap-4">
            {[
              ...
              <div key={index} className="flex items-center">
                ...
                {index < arr.length - 1 && (
                  <svg className="w-5 h-5 mx-3 text-[#4346BE] max-[1039px]:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section id="job-listings" className="relative py-24 border-b border-black/15">
        ...
        <div className="absolute top-[6px] left-[54px] max-[539px]:top-0 max-[539px]:left-[30px]">
          <code className="text-[#313131]" style={{ fontFamily: 'Verdana, sans-serif', fontSize: 'var(--marker-font-size)' }}>{`<section class="job-listings">`}</code>
        </div>

        <div className="max-w-[1180px] mx-auto px-8">
          <div className="mb-8">
            <h2 className="font-bold tracking-[1.08px] mb-2 max-[539px]:!text-[26px]" style={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '36px' }}>現在募集中の求人</h2>
            <div className="w-12 h-[2px] bg-[#313131] max-[539px]:w-[34px]"></div>
          </div>

          {graduateJobs.length > 0 ? (
            <>
              <div className="grid grid-cols-3 gap-6 mb-12 max-[1039px]:grid-cols-2 max-[539px]:grid-cols-1">
              ...
              <div className="flex justify-center gap-6 max-[539px]:flex-col max-[539px]:items-stretch">
            ...
            <div className="bg-gray-50 rounded-2xl p-12 mb-12">
              <div className="text-center max-w-[600px] mx-auto">
                ...
                <Link href="/contact?type=graduate" className="inline-flex items-center gap-4 bg-[#4346BE] text-white rounded-full px-10 py-4 hover:bg-[#3335a0] transition-colors">
